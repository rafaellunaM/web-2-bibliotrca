...
INSERT INTO Book (bookId, title, author, quantity, category, price, availability) VALUES
('B001', 'O Senhor dos Anéis', 'J.R.R. Tolkien', 1, 'Fantasia', 10.0, TRUE),
('B002', '1984', 'George Orwell', 2, 'Distopia', 11.0, TRUE),
('B003', 'O Pequeno Príncipe', 'Antoine de Saint-Exupéry', 3,'Infantil', 12.0, FALSE);
